---
name: commit
description: Safely create Git commits when the user asks to commit changes, including normal repo commits and submodule commits with parent pointer updates. Never push.
---

# Safe Commit

Use this skill when the user asks to commit repo changes.

User args: use the user's requested message, scope, or files from the prompt.
